...
function start_game($game_id){
    ...
    // start interval changing players
    global $TURN_TIME;
    global $change_active_player;
}
...
function set_player_active($player_id, $game_id){
    ...
    make_no_result_querry("UPDATE games SET turn_start_time = CURRENT_TIMESTAMP() WHERE game_id = $game_id");
}
...
function change_active_player (){
    ...
    $active_idx = array_search($active_player, $players);
